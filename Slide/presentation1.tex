...
\newenvironment{autosubsection}[1]{%
    ...
    \vspace{0.2em}%
    \noindent{\normalsize\bfseries \thesection.\theframesubsection\quad #1}\par%
}{}
...
\begin{frame}{1. Introduction}
    ...
    \begin{autosubsection}{Outline}
        
        \begin{autosubsubsection}{Executive Summary}
        \end{autosubsubsection}

        \begin{autosubsubsection}{Definitions}
        \end{autosubsubsection}

        \begin{autosubsubsection}{Research Questions}
        \end{autosubsubsection}

    \end{autosubsection}

    \begin{autosubsection}{Background \& Approach}
        
        \begin{autosubsubsection}{Motivation}
        \end{autosubsubsection}

        \begin{autosubsubsection}{Industry Context}
        \end{autosubsubsection}

        \begin{autosubsubsection}{Project Scope \& Methodology}
        \end{autosubsubsection}

    \end{autosubsection}

        \begin{autosubsection}{Contributions \& Structure}
        
        \begin{autosubsubsection}{Research Outcomes}
        \end{autosubsubsection}

        \begin{autosubsubsection}{Thesis Organisation}
        \end{autosubsubsection}
...
Liquidity Automata: A Computational Hierarchy of Money Forms
