    ...
    (function () {
      ...
      for (let i = 0; i < numCircles; i++) {
        ...
        if (i === 0) {
          ...
          const reducedNarrowBoxWidth = widerAdminBoxWidth * 3 / 4; // Three-quarters the width of Mastercard box
          ...
          const buildCardPathSegments = (startX, startY, primarySource, secondarySource, fallbackBase, providedDistance) => {
            ...
            const turnX = resolveTurnX(primarySource, secondarySource, fallbackBaseValue, startX);
    ...
    if (window.dotPositions && window.dotPositions[0] && window.dotPositions[99]) {
        ...
        } // End of if (i === 0) - SWIFT and related infrastructure
        
        // Only create these boxes once, when we're on the last iteration
        if (i === 99) {
          console.log('ENTERING i=99 block - about to create ADI and other boxes');
        ...
        /* MOVED OUTSIDE THE LOOP - Commenting out duplicate ADI box creation
        ...
        console.log('ADI box debug: Looking for dots 1-91, current i =', i);
        let foundDots = 0;
        ...
        */ // END OF COMMENTED OUT ADI BOX CODE
